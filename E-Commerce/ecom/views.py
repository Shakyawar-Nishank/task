...
def customer_signup_view(request):
    ...
    if request.method=='POST':
        ...
        return HttpResponseRedirect('emailverification')
...
def emailverification(request):
    ...
    if request.method == 'POST':
        ...
        otp = request.POST['one']+request.POST['two']+request.POST['three']+request.POST['four']
        print(otp_g,otp)
        if int(otp) in otp_a:
            context={'error':'False'}
            return redirect('customer-home')
            ...
            context={'error':'true'}
    return render(request,'ecom/verification.html',context)
